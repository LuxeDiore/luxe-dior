...
const page = () => {
  const terms = [
    ...
    {
      description:
        "This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name www.luxedior.in('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').",
      subpoints: null,
    },
    {
      description:
        "The Platform is owned by JASHAN VERMA, a company incorporated under the Companies Act, of 1956 with its registered office at SIRSA, HARYANA, India (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').",
      subpoints: null,
    },
    {
      description:
        "Your use of the Platform and services and tools are governed by the following terms and conditions (“Terms of Use”) as applicable to the Platform including the applicable policies which are incorporated herein by way of reference. If You transact on the Platform, You shall be subject to the policies that are applicable to the Platform for such transaction. By mere use of the Platform, You shall be contracting with the Platform Owner and these terms and conditions including the policies constitute Your binding obligations, with the Platform Owner. These Terms of Use relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, 'Services'). Any terms and conditions proposed by You which are in addition to or which conflict with these Terms of Use are expressly rejected by the Platform Owner and shall be of no force or effect. These Terms of Use can be modified at any time without assigning any reason. You are responsible for periodically reviewing these Terms of Use to stay informed of updates.",
      subpoints: null,
    },
    {
      description:
    ...
    },
    {
      ...
      subpoints: [
        ...
        "You agree and acknowledge that website and the Services may contain links to other thirdparty websites. On accessing these links, you will be governed by the terms of use, privacy policy and such other policies of such third party websites. These links are provided for your convenience for providing further information.",
        ...
        "All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in SIRSA and HARYANA.",
  ...
  return (
    <MaxWidthWrapper>
      <div className="flex flex-col gap-4 pt-14 pb-14 ">
        ...
        <ul className="sm:w-[80%] md:w-[50%] self-center flex flex-col gap-5">
          {terms.map((item, key) => {
            return (
              <div key={key}>
                <li>
